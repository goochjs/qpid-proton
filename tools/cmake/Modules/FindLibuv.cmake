...
find_library(Libuv_LIBRARY Names uv libuv HINTS ${LIBUV_LIBRARYDIR} ${LIBUV_ROOT})
find_path(Libuv_INCLUDE_DIR NAMES uv.h HINTS ${LIBUV_INCLUDEDIR} ${LIBUV_ROOT} ${LIBUV_ROOT}/include)
